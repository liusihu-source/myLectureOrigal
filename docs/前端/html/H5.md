...
:bulb:在html标签的事件属性中可使用this 关键词，减少获取dom的innertext。

```shell
<input type="text" class="s_searchInput" oninput="searchGroup(this.value)" placeholder="搜索分组或学生">

function searchGroup(text) {//do something with text}
```
