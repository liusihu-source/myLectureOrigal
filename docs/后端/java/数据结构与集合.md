...
> 一种程序设计优化的方法论，研究数据的`逻辑结构`和`物理结构`以及它们之间相互关系，并对这种结构定义相应的`运算`，**目的是加快程序的执行速度、减少内存占用的空间。**
...
![image-20231123103442236](数据结构与集合.assets/image-20231123103442236.png)
...
![image-20231123104001866](数据结构与集合.assets/image-20231123104001866.png)
...
![image-20231123105324588](数据结构与集合.assets/image-20231123105324588.png)
...
![image-20231123105526257](数据结构与集合.assets/image-20231123105526257.png)
...
![image-20231123105936539](数据结构与集合.assets/image-20231123105936539.png)
...
![image-20231123110653127](数据结构与集合.assets/image-20231123110653127.png)
...
![image-20231123112932896](数据结构与集合.assets/image-20231123112932896.png)

例如：对象数组

![image-20231123112941416](数据结构与集合.assets/image-20231123112941416.png)
...
![image-20231123134623385](数据结构与集合.assets/image-20231123134623385.png)
...
![image-20231123134929414](数据结构与集合.assets/image-20231123134929414.png)

- 常见的链表结构有如下的形式：

![image-20231123134940975](数据结构与集合.assets/image-20231123134940975.png)

![image-20231123142501710](数据结构与集合.assets/image-20231123142501710.png)

### 3.2 自定义链表

#### 3.2.1 自定义单向链表

![image-20231123143518010](数据结构与集合.assets/image-20231123143518010.png)
...
![image-20231123144321930](数据结构与集合.assets/image-20231123144321930.png)
...
![image-20231123154700805](数据结构与集合.assets/image-20231123154700805.png)

![image-20231123155252391](数据结构与集合.assets/image-20231123155252391.png)
...
![image-20231123173819926](数据结构与集合.assets/image-20231123173819926.png)

![image-20231123205310552](数据结构与集合.assets/image-20231123205310552.png)

## 六、树与二叉树

### 6.1 树的理解

![image-20231123205834911](数据结构与集合.assets/image-20231123205834911.png)
...
![image-20231123205923683](数据结构与集合.assets/image-20231123205923683.png)
...
![image-20231127094300064](数据结构与集合.assets/image-20231127094300064.png)
...
![image-20231127094505752](数据结构与集合.assets/image-20231127094505752.png)

1、`满二叉树`： 除最后一层无任何子节点外，每一层上的所有结点都有两个子结点的二叉树。 第n层的结点数是2的n-1次方，总的结点个数是2的n次方-1

![image-20231127094515260](数据结构与集合.assets/image-20231127094515260.png)

2、`完全二叉树`： 叶结点只能出现在最底层的两层，且最底层叶结点均处于次底层叶结点的左侧。

![image-20231127094545749](数据结构与集合.assets/image-20231127094545749.png)
...
![image-20231127094816947](数据结构与集合.assets/image-20231127094816947.png)
...
![image-20231127095742568](数据结构与集合.assets/image-20231127095742568.png)
...
![image-20231127100122952](数据结构与集合.assets/image-20231127100122952.png)
...
![image-20231127100132766](数据结构与集合.assets/image-20231127100132766.png)
...
![image-20231127100857790](数据结构与集合.assets/image-20231127100857790.png)
...
![image-20231127101353462](数据结构与集合.assets/image-20231127101353462.png)
...
![image-20231127101510888](数据结构与集合.assets/image-20231127101510888.png)
...
![image-20231127101616917](数据结构与集合.assets/image-20231127101616917.png)

- **包含4个元素的LinkedList**

![image-20231127101637799](数据结构与集合.assets/image-20231127101637799.png)

- **add(E e)方法**

![image-20231127101704801](数据结构与集合.assets/image-20231127101704801.png)

- **add(int index,E e)方法**

![image-20231127101718854](数据结构与集合.assets/image-20231127101718854.png)

- **remove(Object obj)方法**

![image-20231127101729358](数据结构与集合.assets/image-20231127101729358.png)

- **remove(int index)方法**

![image-20231127101742470](数据结构与集合.assets/image-20231127101742470.png)
...
![image-20231127103641384](数据结构与集合.assets/image-20231127103641384.png)
...
![image-20231127103904037](数据结构与集合.assets/image-20231127103904037.png)
...
![image-20231127104120364](数据结构与集合.assets/image-20231127104120364.png)
...
![image-20231127104418092](数据结构与集合.assets/image-20231127104418092.png)
...
![image-20231127104714446](数据结构与集合.assets/image-20231127104714446.png)
...
https://www.bilibili.com/video/BV1PY411e7J6?p=153&vd_source=c3aed98126d5ffa7b2c72cf011d9383c
